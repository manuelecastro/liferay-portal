...
public class RememberMeTokenPersistenceTest {
	...
	public void testUpdateExisting() throws Exception {
		...
		Assert.assertEquals(
			existingRememberMeToken.getAccessToken(),
			newRememberMeToken.getAccessToken());
		Assert.assertEquals(
	...
	public void testResetOriginalValues() throws Exception {
		...
		_assertOriginalValues(
			_persistence.findByPrimaryKey(newRememberMeToken.getPrimaryKey()));
	}
	...
	protected RememberMeToken addRememberMeToken() throws Exception {
		...
		rememberMeToken.setAccessToken(RandomTestUtil.randomString());
