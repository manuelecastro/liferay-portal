...
/**
 * Performs no permission check of its own. Saving reaches {@code
 * ConfigurationPersistenceManager}, which calls the FIPS session
 * configuration model listener before persisting, and that listener refuses
 * any write not made by a Crypto Officer. Repeating the check here would be a
 * second place to keep in step with the rule.
 *
