...
public class RoleModelListener extends BaseModelListener<Role> {
	...
	public void onAfterRemoveAssociation(
		...
		try {
			...
			_addOrUnsetPasswordPolicyUser(role, true, userId);
		}
	...
	public void onBeforeAddAssociation(
		...
		try {
			_addOrUnsetPasswordPolicyUser(
				_roleLocalService.fetchRole((long)classPK), false,
	...
	private void _addOrUnsetPasswordPolicyUser(
			Role role, boolean unset, long userId)
