...
public class OpenIdConnectProviderConfigurationListener
	...
	protected void activate(BundleContext bundleContext) {
		_serviceTrackerMap = ServiceTrackerMapFactory.openSingleValueMap(
			...
			new OpenIdConnectProviderConfigurationListenerServiceTrackerCustomizer(
				bundleContext));
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OpenIdConnectProviderConfigurationListener.class);
	...
	private class
		OpenIdConnectProviderConfigurationListenerServiceTrackerCustomizer
			implements EagerServiceTrackerCustomizer
				<ConfigurationProvider<?>, ConfigurationProvider<?>> {

		public OpenIdConnectProviderConfigurationListenerServiceTrackerCustomizer(
