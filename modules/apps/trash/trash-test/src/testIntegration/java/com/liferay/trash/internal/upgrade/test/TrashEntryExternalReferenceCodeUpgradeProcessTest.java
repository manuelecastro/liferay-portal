...
public class TrashEntryExternalReferenceCodeUpgradeProcessTest extends
	...
	protected ExternalReferenceCodeModel fetchExternalReferenceCodeModel(
		...
		TrashEntry trashEntry =
			(TrashEntry)externalReferenceCodeModel;

		return _trashEntryLocalService.fetchTrashEntry(
