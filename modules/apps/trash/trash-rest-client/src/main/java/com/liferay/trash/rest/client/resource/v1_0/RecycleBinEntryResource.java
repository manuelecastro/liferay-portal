...
package com.liferay.trash.rest.client.resource.v1_0;
...
import com.liferay.trash.rest.client.problem.Problem;
...
public interface RecycleBinEntryResource {
	...
	public static class Builder {
		...
		public RecycleBinEntryResource build() {
			return new RecycleBinEntryResourceImpl(this);
		}
	...
	public static class RecycleBinEntryResourceImpl
		...
		public Page<RecycleBinEntry> getRecycleBinEntriesPage(
			...
			try {
				return Page.of(content, RecycleBinEntrySerDes::toDTO);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public RecycleBinEntry getRecycleBinEntryByExternalReferenceCode(
			...
			try {
				return RecycleBinEntrySerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/recycle-bin/v1.0/recycle-bin-entries/by-external-reference-code/{externalReferenceCode}");
		...
		private RecycleBinEntryResourceImpl(Builder builder) {
			_builder = builder;
		}

		private static final Logger _logger = Logger.getLogger(
			RecycleBinEntryResource.class.getName());
