...
public class TimeBasedOTPBrowserSetupMFAChecker
	...
	private void _sendCodeMultipleUseEmail(
		...
		LocalizedValuesMap subjectLocalizedValuesMap =
			mfaTimeBasedOTPConfiguration.emailTOTPSentSubject();

		String subject = subjectLocalizedValuesMap.get(user.getLocale());

		LocalizedValuesMap bodyLocalizedValuesMap =
			mfaTimeBasedOTPConfiguration.emailTOTPSentBody();
