...
public class RememberMeTokenModelImpl
		...
		static {
			...
			attributeSetterBiConsumers.put(
				...
				(BiConsumer<RememberMeToken, String>)
					RememberMeToken::setAccessToken);
			attributeSetterBiConsumers.put(
				"expirationDate",
				(BiConsumer<RememberMeToken, Date>)
	...
	public CacheModel<RememberMeToken> toCacheModel() {
		...
		rememberMeTokenCacheModel.accessToken = getAccessToken();

		String accessToken = rememberMeTokenCacheModel.accessToken;

		if ((accessToken != null) && (accessToken.length() == 0)) {
			rememberMeTokenCacheModel.accessToken = null;
		}
